...
угроза, чем прошедшая война. В пустоте за пределами пространства и времени затаились
Древние — злобные и могущественные существа.
Они жаждут ворваться в наш мир через межпространственные врата, которые начали
открываться в Аркхэме. Если не закрыть эти
порталы, человечество не устоит перед натиском Древних. На пути ужасов Аркхэма стоит
только горстка сыщиков. Справятся ли они?*

**«Ужас Аркхэма»** позволит 1—8 игрокам (рекомендуем играть втроём — впятером) за 2—4 часа спасти
человечество от вторжения Древних и их приспешников. Место действия — вымышленный городок
...
Аркхэма». В него включены все исправления, сделанные разработчиками после выхода первой версии
...
Барнс. Кроме того, в этом выпуске исправлены ошибки и опечатки, которые встречались в предыдущих
...
несущее гибель всему человечеству. Ткань пространства и времени истончается, и по всему Аркхэму
...
и разрушение. Об этой угрозе известно только горстке сыщиков. Общими усилиями они стремятся
...
В **«Ужасе Аркхэма»** сыщики посещают достопримечательности и исследуют глухие закоулки города,
...
городу оружие, заклинания, улики. Позже он научится истреблять монстров, закрывать врата и запечатывать наиболее опасные из них.
...
смогут посетить эти локации. Игровое поле рассмотрено в подробностях на стр. 21.
...
## Листы и фишки сыщиков
Каждый игрок получает один
лист сыщика, на котором указаны свойства, навыки и стартовое
имущество героя. В комплекте
с листом сыщика идёт фишка
этого персонажа, которая указывает его текущее местоположение на поле. Лист сыщика подробно разобран на стр. 21.
...
![image](https://user-images.githubusercontent.com/9703565/51134596-b4b14200-1840-11e9-8ae0-e4660b826e3d.png)
...
![image](https://user-images.githubusercontent.com/9703565/51134652-db6f7880-1840-11e9-8f73-55976483bef2.png)

• Жетоны рассудка — показатель ментального здоровья героя: чем их меньше,
...
## Карты сыщиков
Карты сыщиков можно отличить по небольшому размеру. Они представляют собой всё, что приобретают
...
![image](https://user-images.githubusercontent.com/9703565/51134745-12458e80-1841-11e9-8a47-39326bc2a15f.png)

**Простые вещи:** повседневные, но полезные предметы (в том числе оружие), которые помогают сыщику
в его нелёгком деле.
...
![image](https://user-images.githubusercontent.com/9703565/51134923-82541480-1841-11e9-847e-2255fc721669.png)
...
последователей. Лист
Древнего в деталях рассмотрен на стр. 19.
...
![image](https://user-images.githubusercontent.com/9703565/51135094-e70f6f00-1841-11e9-9bbb-c66a37bc60dc.png)


Карты **локаций** указывают, что происходит с сыщиком при посещении того или иного места в Аркхэме.
Девяти районам города соответствуют девять колод
локаций разных цветов. Каждая из семи карт «районной» колоды содержит описание трёх контактов —
...
сыщика с обитателями Иных миров на их территории. В отличие от локаций, разделённых по районам,
карты врат всегда замешиваются в одну колоду.
Об Иных мирах читайте на стр. 8—9 и 21.

Карты **Мифа** отвечают за события, которые
случаются в Аркхэме независимо от действий сыщиков. Каждый раунд в фазе Мифа вскрывается одна
такая карта. Она влияет на игру несколькими способами: указывает, в какой локации открываются
новые врата, где появляются улики, как передвигаются монстры, а также что происходит в городе —
...
## Маркеры "Активность" и "Исследовано"

Маркером «Активность» отмечают локацию, где,
согласно картам Мифа, происходят необычные
события (текст карты будет упоминать такой маркер). Маркер «Исследовано» кладут под фишку
...
получает жетоны здоровья и рассудка (столько, сколько указано на листе его персонажа), а также стартовое
...
1. **Перетасуйте карты сыщиков**<br>
...
1. **Завершите подготовку сыщиков**<br>
...
игрок не глядя вытягивает жетон из пула и размещает его на поле в соответствии с правилами или
...
1. **Перетасуйте карты Древних и жетоны врат**<br>
И Жетоны ВРАт
Перетасуйте колоды локаций, врат и Мифа, и положите их рядом с полем. Затем перемешайте
16 жетонов врат лицом вниз и сложите их стопкой
рядом с полем.

1. **Поставьте сыщиков на поле**<br>
...
сыщики завершают свои дела в одной фазе, начинается следующая. В конце последней фазы раунда
...
**Фаза I. Передышка**<br>
**Фаза II. Движение**<br>
**Фаза III. контакты в Аркхэме**<br>
**Фаза IV. контакты в Иных мирах**<br>
**Фаза V. Миф**
...
обратно лицом вверх. Помните: вы не можете пользоваться картой, пока она лежит лицом вниз, до следующей передышки такая карта бесполезна.<br>
...
аванс в следующий раз или нет: для этого надо бросить кубик. Если выпадет единица, ему придётся
избавиться от «Задатка».
1. **Изменение навыков**<br>
Наконец, в фазе передышки вы можете изменить
навыки своего сыщика, сдвинув ползунки на соответствующих треках. О том, как это делается, рассказывает схема «Изменение навыков» на этой странице.<br>
**Исключение:** в начале игры вы можете выставить
ползунки на любые позиции треков, не обращая внимания на собранность персонажа. При подготовке
обычные правила не действуют.

![image](https://user-images.githubusercontent.com/9703565/51136565-78ccab80-1845-11e9-9f1f-0c17f8499aab.png)
...
ползунок знаний/удачи смещается на 1 деление влево, а соотношение скорости и скрытности меняется на 2 позиции в пользу первой.*
...
словами, единица движения позволяет сыщику переместиться либо между двумя смежными улицами,
либо между локацией и улицей одного района.

**Локации** обозначены круглыми иллюстрациями
в городской части поля. **Улицы** — это прямоугольники с названиями отдельных районов Аркхэма
(например «Ривертаун» или «Университет Мискатоник»).
...
находящимися там монстрами, либо скрыться бегством от каждого из них (читайте «Бой» и «Уход от
...
3) переход с улиц Фрэнч Хилл на улицы Университета Мискатоник тоже израсходует 1 единицу;
...
она переходит во вторую зону. В фазе движения следующего раунда Аманда
...
Если скрыться от монстра не удалось, сыщик получает боевой урон, указанный на жетоне монстра
...
часть. Нельзя подбирать улики в тех локациях, которые сыщик проходит без остановки: сбор улик возможен только при полном прекращении движения.
Движение по Иному миру
...
Обратите внимание на полосу поперек каждой круглой ячейки: она делит Иной мир на две зоны. Если
...
получает единиц движения в Аркхэме и не перемещается в Иных мирах: вместо этого его фишка возвращается в нормальное положение. В следующем раунде он сможет переместиться по обычным правилам.
...
зону Страны снов .
2. Врата есть
Если в локации есть открытые врата, сыщика затягивает в них. Он переходит в первую (левую) зону
...
он вернулся в Аркхэм, пока он остаётся в этой локации. Более того, именно в такой ситуации сыщик
может закрыть или запечатать врата (см. «Закрытие и запечатывание врат», стр. 17). Если сыщик
...
в ходе контакта, он задержан, как если бы был затянут во врата в фазе Мифа.
...
мира, в котором находится сыщик. Карты неподходящих цветов кладите под колоду лицом вниз.
Получив карту нужного цвета, игрок ищет на ней
описание контакта для того мира, в котором находится сыщик, зачитывает текст контакта вслух
...
В локации с жетоном знака Древних ничего не происходит. Врата не открываются, монстры не появляются. Знак Древних навечно разрывает связь этой
...
монстров, появляющихся при наплыве, равно большему из двух показателей: количество игроков или
...
Чёрной пещеры: к любым другим вратам его поставить нельзя, так как наплыв монстров начался не
...
Если после этого все деления трека закрыты жетонами, Древний пробуждается, и игра переходит
...
кладёт его лицом вверх в нужную локацию и сбрасывает все лежавшие там улики: сыщики упустили
возможность найти эти следы.
3. Вторжение монстра
Первый игрок вслепую тянет жетон из пула монстров и кладёт его в локацию. Если из-за этого лимит
...
безысходности: трек ещё только начинает заполняться, и до пробуждения Древнего далеко, так что
игрок берёт из стопки верхний жетон врат
и кладёт его в Чёрную пещеру. Врата открываются: оказалось, они ведут на Юггот. Наконец, игрок
...
зону того мира, куда ведут врата. Из-за неожиданного происшествия сыщик задержан: положите его
...
там нет открытых врат. Если в этой локации присутствует один или несколько сыщиков, кто-то из них
может сразу подобрать улику. Претенденты должны
сами решить, кто это сделает, иначе их спор разрешает первый игрок.
3. Д ВИЖенИе МонСтРоВ
Появившись в локации с вратами, монстр не обязан
провести возле них всю игру, и он выходит на улицы
города. Понять, кто куда идёт в этом раунде, поможет вытянутая карта Мифа — а именно, поле движения в её нижнем правом углу. За перемещение
...
движения вытянутой карты Мифа, этот монстр должен двигаться в текущем раунде.
...
того, в какой из этих половин находится пиктограмма монстра, зависит, по какой стрелке он будет двигаться.
10
Д ВИЖенИе МонСтРоВ
...
вообще не двигается.
Пример 2: в белой части поля движения квадрат и ромб, в чёрной — круг. Монстры с квадратом или ромбом идут по белым стрелкам, с кругом — по чёрным. А именно:
...
событий.
Первый игрок находит на игровом поле всех монстров с теми же символами, что стоят в поле движения
вытянутой карте Мифа. Затем он перемещает их по
следующим правилам:
• если символ монстра стоит в белой части поля движения, он движется по белой стрелке, выходящей из
его текущей локации;
• если символ монстра стоит в чёрной части поля
движения, он движется по чёрной стрелке, выходящей из его текущей локации;
Важно: многие стрелки на игровом поле двухцветные. Монстр движется по таким стрелкам, в какой
...
движение завершается: второго шага он уже не делает. При этом столкновения с монстром не происходит, но в следующей фазе движения сыщик должен
...
Большинство монстров движутся по вышеописанным правилам, но у некоторых особые повадки.
...
инструкции.
Летающий (синий кант): такие монстры либо подлетают к ближайшему сыщику на улице, либо поднимаются в небо (особая зона игрового поля).
...
с летающим монстром нет сыщиков, он перемещается на смежную улицу, где есть хотя бы
...
с полем лицом вверх. Если в игре уже был действующий процесс, он отменяется, и его карта сбрасывается лицом вниз под колоду Мифа. Два процесса одновременно в Аркхэме идти не могут ни при каких
обстоятельствах.
Слухи: свойство карты-слуха влияет на игру, пока
в партии не сложатся обстоятельства, указанные
в карте Мифа как опровержение или подтверждение. На этом розыгрыш карты завершается, и она
...
подтипа вытянута, когда в игре уже есть слухи, свойство новой карты в силу не вступает (однако все
остальные предписанные ей действия, такие как расстановка врат и монстров, распределение улик и движение монстров, выполняются).
...
с наибольшим числом трофеев-врат получает почётный титул Первого гражданина. При равном числе
...
трофеев-врат (+8), 17 оставшихся трофеевмонстров (+5) и 5 здоровых сыщиков в своём уме
...
действий. У каждого сыщика шесть навыков, текущие значения которых отмечаются ползунками на
...
конец игры
12
Знание: память, восприятие, умение учиться, мистические таланты и способности. Необходимо для применения заклинаний.
...
повезёт);
• сложность проверки (при сложности 1 не указывается).
Пример 1: «Пройдите проверку скрытности (−1)».
Сыщик использует навык скрытности с модификатором (в данном случае штрафом) −1. Сложность
...
Пример: Майкл МакГленн должен пройти две проверки из приведённых выше примеров. Его скрытность сейчас 3, удача 2. В первой проверке он вынужден убрать из броска 1 кубик из-за штрафа
...
Важно: если из-за модификатора вы должны бросить 0 или меньше кубиков, сыщик автоматически
...
проверке навыка, чтобы пройти её. Успехом считается каждый кубик, на котором выпало 5 или 6.
Помните, что если сложность проверки не указана,
она равна 1.
Пример 1: Майкл МакГленн бросает 2 кубика в проверке скрытности, описанной выше. Выпало 2 и 5.
Один успех есть, и для этого испытания его вполне
хватает: сложность не указана, так что это проверка со сложностью 1, и сыщик её прошёл.
...
Например, проверка ухода — особая проверка навыка скрытности. Карта «Скрытность», увеличивающая
одноимённый навык на 1, сработает и при проверке
ухода, а «Тёмный плащ» (обычная вещь, дающая
бонус +1 к проверкам ухода) на проверки скрытности не повлияет никак.
...
должен пройти во что бы то ни стало, он сбрасывает одну улику и кидает кубик, получая 3. Это провал, но ещё не конец! Джо тратит вторую улику,
...
Важно: расход улики всегда позволяет игроку бросить один кубик, даже если штрафы опустили
...
Сыщик сможет избежать боя с монстром, если пройдёт проверку ухода. Проверка ухода основана на
скрытности сыщика. Модификатором выступает
бдительность монстра (число в верхнем правом
углу на лицевой стороне жетона). Сложность проверки ухода всегда равна 1, если только у монстра нет
особого свойства.
...
хотя бы один их них принесёт успех. Пройдя проверку, он избежит столкновения с Отродьем и сможет
...
Пример: только что успешно ушедший от Звёздного отродья Пит может остаться в Нортсайде,
избежав боя. Однако в своей следующей фазе движения Пит будет вынужден сделать выбор: биться
с Отродьем или снова уходить от него.
Если в зоне больше одного монстра, сыщик должен
уйти от каждого монстра по очереди, в любом угодном ему порядке. Провалив проверку ухода, сыщик
...
сыщика завершается уже после первого проваленного ухода.
Пример: Пит встретил Звёздное отродье и шоггота и вынужден уходить от обоих, чтобы пройти в
Лавку древностей. Если Пит решит уходить сначала от Звёздного отродья и провалит проверку, он
...
Проверка ужаса основана на воле сыщика, а модификатором выступает рейтинг ужаса (число в левом
...
происходит. При провале сыщик теряет столько единиц рассудка, сколько указано на жетоне монстра
...
боевой урон, и она потеряет 4 единицы здоровья. Если после этого она останется
...
проверку битвы. Проверка битвы основана на навыке боя, а модификатором выступает боевой рейтинг
монстра (число в правом нижнем углу на обороте
жетона). Сложность проверки равна стойкости
монстра — числу капель крови в нижней части оборотной стороны жетона.
...
−3, и Пит бросает три кубика. Стойкость монстра и, следовательно, сложность проверки
...
урон сыщику.
Важно: чтобы убить монстра, сыщик должен получить необходимое число успехов одной проверкой.
...
и в следующем кругу боя сыщик снова будет проходить проверку битвы против сложности 3.
3. У Рон МонСтРоВ
...
сознание (см. стр. 16).
У некоторых монстров к боевому урону добавляются особые эффекты. Так, Ночной страдалец
...
2 единицы рассудка, как показано символами под рейтингом ужаса Старейшины.
...
для победы, Аманда получила. Старейшина повержен! Аманда забирает его
жетон как трофей.
Если бы Аманда провалила проверку, старейшина нанёс бы ей боевой урон, вынудив
потерять 1 единицу здоровья и 1 оружие
или заклинание по её выбору. Затем ей
пришлось бы выбирать между отступлением и боем. Но вот новой проверки
...
действует всегда, не требуя каких-либо дополнительных проверок. Однако оружие, как правило, оказывает физическое воздействие, которое не действует
против многих монстров.
Заклинания обладают магическим воздействием,
поэтому они эффективны против большинства
монстров. Однако чтобы получить бонус от заклинания, сыщик должен прочитать его (см. «Чтение
...
значки-руки. Одновременно сыщик может использовать оружие и заклинания в любых сочетаниях, пока
...
менять используемые карты, однако оружие и заклинания перестают приносить пользу, едва сыщик выпустит
...
воздействие, бонус +4) и «Увяданием» (1 рука, магическое воздействие, бонус +6). Пит смог прочитать
...
должен успешно его прочесть. У каждого заклинания есть сложность прочтения, и большинство из
...
отдаёт 1 единицу рассудка. Затем он проходит проверку знания (+1). Его навык знания равен 4,
и сыщик получает для броска 5 кубиков. Выпало
2 успеха (хватило бы и одного), заклинание прочитано. Уолтерс может получить здоровье по числу
...
параметров отмечаются соответствующими жетонами. В начале игры сыщик получает жетоны здоровья
...
Игрок сбрасывает половину вещей и улик обезумевшего героя (по своему выбору, округляя вниз),
...
сыщика, который был израсходован в ноль, восстанавливается до 1 единицы.
Важно: сбрасывая половину вещей сыщика, учитывайте все его простые вещи, уникальные вещи,
...
свой следующий ход. В фазе движения пропущенного раунда фишка потерянного сыщика возвращается
в вертикальное положение. В начале фазы передышки следующего (после пропущенного) раунда игрок
...
Сыщик не может быть проклят и благословлён одновременно. Если благословлённый сыщик проклят, он
попросту теряет благословение. И наоборот, благословение снимает проклятие. Сыщик не может нести
...
в локации. Сыщик сможет предпринять новую попытку закрыть их в своей следующей фазе контактов
...
его в локацию с запечатанными вратами.
...
сыщики могут запечатывать врата. В колоде несколько таких карт. Чтобы применить знак Древних,
...
сможет закрыть и запечатать врата не проходя проверку знания или боя и не тратя улик.
Знак Древних применяется так:
• Снимите с листа вашего сыщика по 1 жетону рассудка и здоровья (из-за этого сыщик может сойти
...
в коробку. Каждая такая карта может быть применена только один раз на протяжении партии.
...
останется в локации, он должен будет биться с монстрами или уходить от них по обычным правилам.
Число одновременно находящихся в Аркхэме монстров не может быть выше определённого лимита.
...
Если вам надо выставить монстра в Аркхэм в нарушение лимита монстров, вместо этого положите его
жетон на окраину — в особую зону поля. Здесь монстры остаются до тех пор, пока не переполнят и её.
...
7 1
8 0
Если число монстров на окраине превышает её вместительность, все монстры оттуда уходят в пул,
...
числу игроков (например, сыщики добиваются четвёртого успеха в игре вчетвером),
с трека Древнего снимается жетон безысходности, а счёт успехов обнуляется.
...
и налагает тот или иной штраф в случае провала.
к онец бИтВы
Как только игроки снимают с листа
Древнего последний жетон безысходности, Древний сокрушён, и сыщики
побеждают!
...
Аркхэма напуганы происходящими в городе событиями. Уровень ужаса может расти по разным
...
Если маркер уже стоит на 10-м делении трека, а уровень ужаса надо повысить дальше (например, из-за
...
союзников в колоде не останется, это правило перестанет работать.
...
Когда уровень ужаса достигнет 10, Аркхэм захлёстывает волна чудовищ. Лимит монстров снимается до
...
прогнать его обратно с помощью тех знаний и оружия, которые они получили в ходе игры.
Древний просыпается, если выполнено одно из пяти
следующих условий:
1. Полный трек безысходности
По мере того как в Аркхэме появляются врата,
деления на треке безысходности Древнего закрываются жетонами. Как только на треке будет закрыто последнее свободное деление, Древний сразу же
проснётся.
...
как только количество открытых врат в городе достигает определённого уровня, зависящего от числа
игроков.
...
его трек безысходности полностью заполнен жетонами, перед битвой с ним игроки обязаны выложить
...
2. Атмосферный текст: игровой нагрузки не несёт, просто создаёт атмосферу.
3. Рейтинг ужаса: модификатор для проверки ужаса перед боем с этим монстром.
...
6. боевой урон: столько жетонов здоровья сбрасывает сыщик, провалив
проверку битвы.
...
труднее вербовать союзников, и со временем начнут закрываться торговые локации
...
по тем или иным причинам оказались потерянными во времени и пространстве.
...
сыщика. Сыщик не сможет получить больше жетонов здоровья, чем позволяет этот
...
7. Собранность позволяет изменять значения навыков (см. стр. 6).
...
игроки сначала получают возможность подготовиться к продолжению боя. Затем каждый сыщик атакует
...
ползунки навыков по обычным правилам фазы передышки. Потом жетон первого игрока передаётся
...
В отличие от обычной битвы, одной атаки для победы над Древним не хватит. Вместо этого игроки
...
Если сыщики снимают последний жетон безысходности с листа Древнего, они сокрушают врага
(см. «Конец игры», стр. 12).
3. Атака Древнего
Когда все игроки (кроме выведенных из игры) сделают проверки битвы, Древний по разу атакует каждого сыщика. У каждого Древнего своя атака, но все
...
Если атака Древнего лишает сыщика последней единицы рассудка или здоровья, он сожран. Сыщик,
...
особым свойством места вместо того, чтобы вступать в контакт. Если в локации есть открытые врата,
особое свойство применить невозможно.
Пример: в «Доме Науки» можно провести вскрытие. Это свойство позволит сыщику обменять
...
вытягивает из пула жетон монстра, и сыщик разбирается с ним по обычным правилам (то есть, пытается
...
В ходе некоторых контактов в локации одновременно появляются монстр и врата. В таком случае оба
эти жетона остаются на поле. Однако если карта контакта говорит о появлении одного только монстра
(без врат), его жетон уходит с поля сразу после
завершения контакта. Если такой монстр убит, игрок
забирает его жетон как трофей (если этому не препятствует особое свойство монстра). Если же такой
...
одновременно. Это относится к «Банковским ссудам», «Задаткам», «Проклятиям», «Благословениям»
и «Членским билетам Ложи Серебряных Сумерек».
Разное
22
Р АСхоДоВАнИе Денег
Когда ваш сыщик приобретает то или иное снаряжение, верните в банк нужное количество денег.
...
целых $5. Потраченные трофеи-монстры возвращайте в пул монстров, а врата — под низ стопки жетонов врат.
...
в одной зоне Иного мира могут меняться друг с другом деньгами, простыми и уникальными вещами
...
Fantasy Flight Publishing, Inc. Перепечатка и публикация правил игры, компонентов игры и иллюстраций без разрешения правообладателя запрещены.
...
врата: 17—18
запечатывание врат: и победа в игре: 12; как запечатать врата: 18
засада: 24
знак Древних: 18
игровое поле: 21
исследовано: 4, 8
...
Если локация отмечена одним из вышеприведённых значков белого цвета на чёрном круге (см. значок рассудка на
...
монстра карта, оказывающая физическое (магическое) воздействие, даёт половину обычного бонуса (округляя вверх).
...
фаза V. Миф
При передышке игроки получают деньги, платят проценты по ссудам, восстанавливают задействованные ранее
...
успехов (результатов 5 или 6), необходимое для прохождения проверки.
о Собые ПРоВеРкИ
Есть 4 типа особых проверок: уход, ужас, битва и заклинание. Каждая из этих проверок основана на одном из
базовых навыков. Бонус к базовому навыку распространяется на особые проверки, но не наоборот.
...
5—6 6 открытых врат
7—8 5 открытых врат
ВАЖно: даже если Древний проснулся не от заполнения трека безысходности, на последнюю битву он
...
монстр, который должен быть поставлен на поле в нарушение этого лимита, ставится на окраину.
